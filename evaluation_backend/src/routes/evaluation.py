...
from src.models.evaluation import db, EvaluationSubmission
...
def submit_evaluation():
    ...
    try:
        ...
        submission = EvaluationSubmission(
            ...
            program_rating=int(data.get('program_rating', 0)) if data.get('program_rating') else None,
            program_pros=data.get('program_pros'),
            program_cons=data.get('program_cons'),
            leaders_rating=int(data.get('leaders_rating', 0)) if data.get('leaders_rating') else None,
            leaders_pros=data.get('leaders_pros'),
            leaders_cons=data.get('leaders_cons'),
            games_rating=int(data.get('games_rating', 0)) if data.get('games_rating') else None,
            games_pros=data.get('games_pros'),
            games_cons=data.get('games_cons'),
            goal_delivery_rating=int(data.get('goal_delivery_rating', 0)) if data.get('goal_delivery_rating') else None,
            goal_delivery_pros=data.get('goal_delivery_pros'),
            goal_delivery_cons=data.get('goal_delivery_cons'),
            logo_rating=int(data.get('logo_rating', 0)) if data.get('logo_rating') else None,
            logo_pros=data.get('logo_pros'),
            logo_cons=data.get('logo_cons'),
            gift_rating=int(data.get('gift_rating', 0)) if data.get('gift_rating') else None,
            gift_pros=data.get('gift_pros'),
            gift_cons=data.get('gift_cons'),
            secretary_rating=int(data.get('secretary_rating', 0)) if data.get('secretary_rating') else None,
            secretary_pros=data.get('secretary_pros'),
            secretary_cons=data.get('secretary_cons'),
            media_rating=int(data.get('media_rating', 0)) if data.get('media_rating') else None,
            media_pros=data.get('media_pros'),
            media_cons=data.get('media_cons'),
            emergency_rating=int(data.get('emergency_rating', 0)) if data.get('emergency_rating') else None,
            emergency_pros=data.get('emergency_pros'),
            emergency_cons=data.get('emergency_cons'),
            kitchen_rating=int(data.get('kitchen_rating', 0)) if data.get('kitchen_rating') else None,
            kitchen_pros=data.get('kitchen_pros'),
            kitchen_cons=data.get('kitchen_cons'),
            finance_rating=int(data.get('finance_rating', 0)) if data.get('finance_rating') else None,
            finance_pros=data.get('finance_pros'),
            finance_cons=data.get('finance_cons'),
            custody_rating=int(data.get('custody_rating', 0)) if data.get('custody_rating') else None,
            custody_pros=data.get('custody_pros'),
            custody_cons=data.get('custody_cons'),
            purchase_rating=int(data.get('purchase_rating', 0)) if data.get('purchase_rating') else None,
            purchase_pros=data.get('purchase_pros'),
            purchase_cons=data.get('purchase_cons'),
            transportation_rating=int(data.get('transportation_rating', 0)) if data.get('transportation_rating') else None,
